...
const CONTRACT_META = {
	address: "0xb11ce3eff88ff4022b940561c4d7b7002323b666",
...
export type PurchasedData = { id: string; contents: string; price: number; };
...
export type Client = {
	...
	dataResponse(id: string): Promise<PurchasedData>;
}
